  ...
  return (
    ...
    >
      ...
      <FadeInUp className="relative z-10 text-center px-4 max-w-5xl mx-auto flex flex-col items-center">
        <h1 className="text-white text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-wider uppercase mb-4 drop-shadow-sm min-h-[1.2em]">
          <Typewriter words={["Contact Us"]} loop={false} cursorStyle="|" cursorClassName="text-indigo-400 animate-cursor-blink ml-1" />
        </h1>
